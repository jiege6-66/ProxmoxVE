...
msg_info "正在安装 Docker $DOCKER_LATEST_VERSION"
...
msg_info "正在安装 Home Assistant $CORE_LATEST_VERSION"
...
msg_ok "已安装 Home Assistant $CORE_LATEST_VERSION"
