...
msg_info "正在创建 configuration file"
cat <<'EOF' >/var/lib/romm/config/config.yml
# RomM Configuration File
# Documentation: https://docs.romm.app/latest/Getting-已启动/Configuration-File/
...
msg_info "正在创建 environment file"
...
msg_ok "已创建 environment file"

msg_info "正在设置 RomM Backend"
cd /opt/romm
