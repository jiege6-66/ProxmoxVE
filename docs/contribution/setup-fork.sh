...
# upstream   https://github.com/jiege6-66/ProxmoxVE.git (fetch)
# upstream   https://github.com/jiege6-66/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/jiege6-66/ProxmoxVE"
echo ""
